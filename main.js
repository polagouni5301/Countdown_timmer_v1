...
const audioStartTime = new Date('2024-12-17T20:26:00'); // Set audio to start at 8:26 PM
const audioDuration = 204; // 3:24 in seconds
...
function updateCountdown() {
  ...
  // Check if it's time to start the audio
  const timeUntilAudio = audioStartTime.getTime() - now;
  if (timeUntilAudio <= 0 && timeUntilAudio > -(audioDuration * 1000)) {
